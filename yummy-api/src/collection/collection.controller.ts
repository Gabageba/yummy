...
export class CollectionController {
  ...
  create(
    ...
    return this.collectionService.create(collection, authorization);
  }
  ...
  findAll(
    ...
    return this.collectionService.findAll(params, authorization);
  }
  ...
  remove(
    ...
    return this.collectionService.delete(id, authorization);
  }
  ...
  update(
    ...
    return this.collectionService.update(id, collection, authorization);
  }
